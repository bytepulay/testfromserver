                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer-register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="occupation" type="text" class="form-control " name="occupation" value="{{ old('occupation') }}" required autocomplete="occupation" autofocus>

                               
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nrc" class="col-md-4 col-form-label text-md-right">{{ __('NRC Number') }}</label>

                            <div class="col-md-6">
                                <input id="nrc" type="text" class="form-control " name="nrc" value="{{ old('nrc') }}" required autocomplete="nrc" autofocus>
